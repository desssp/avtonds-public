    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.IntegerField(verbose_name='Тип пользователя')),
            ...
            managers=[
                ('objects', default.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserSession',
            fields=[
                ...
                ('message', models.TextField(null=True, verbose_name='Ошибка или результат')),
